  ...
  return (
    <div className="w-full max-w-6xl mx-auto p-6 bg-white">
          ...
          <table className="w-full">
            ...
            <tbody>
              <tr className="border-b">
                ...
                <td className="text-right">{totalPowerKw.toFixed(1)} kW × ${powerCost}/kWh</td>
                <td className="text-right">${Math.round(monthlyPowerCost).toLocaleString()}</td>
              </tr>
              <tr className="border-b">
                <td className="py-2">Datacenter Space</td>
                <td className="text-right">{rackSpaceNeeded} racks × $350/rack</td>
              ...
              <tr className="border-b">
                ...
                <td className="text-right">{serversNeeded} servers × $100</td>
      ...
      <div className="mb-8">
        ...
        <div className="bg-gray-50 p-4 rounded-lg">
          ...
          <div className="text-lg">
            {storageCapacity} PiB × 1,024 TiB/PiB × {totalRewardRate.toFixed(2)} FIL/TiB/day × 30 days × ${filPriceCad.toFixed(2)} CAD/FIL
          </div>
      ...
      <div className="mb-8">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="bg-blue-50 p-4 rounded-lg">
            <h3 className="font-bold mb-2 text-blue-900">⚡ Electricity Cost</h3>
            <ul className="text-sm space-y-1">
              <li>• Quebec: $0.055-0.075/kWh (Hydro-Québec)</li>
              <li>• US Average: $0.12-0.15/kWh</li>
              <li>• <span className="font-bold text-green-700">40-60% savings on power</span></li>
              <li>• 100% renewable hydroelectric</li>
            </ul>
          </div>
          <div className="bg-green-50 p-4 rounded-lg">
            <h3 className="font-bold mb-2 text-green-900">🏢 Regulatory Environment</h3>
            <ul className="text-sm space-y-1">
              <li>• Crypto-friendly province</li>
              <li>• Clear tax treatment (business income)</li>
              <li>• No state-level restrictions</li>
              <li>• Mature datacenter ecosystem</li>
            </ul>
          </div>
          <div className="bg-purple-50 p-4 rounded-lg">
            <h3 className="font-bold mb-2 text-purple-900">❄️ Climate Benefits</h3>
            <ul className="text-sm space-y-1">
              <li>• Cold climate = free cooling 6+ months/year</li>
              <li>• Reduced HVAC costs (15-25% savings)</li>
              <li>• Lower equipment failure rates</li>
              <li>• Extended hardware lifespan</li>
            </ul>
          </div>
          <div className="bg-orange-50 p-4 rounded-lg">
            <h3 className="font-bold mb-2 text-orange-900">💰 Financial Incentives</h3>
            <ul className="text-sm space-y-1">
              <li>• Investissement Québec programs</li>
              <li>• R&D tax credits (30-37.5%)</li>
              <li>• Lower corporate tax vs US (26.5%)</li>
              <li>• Accelerated CCA on hardware</li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div className="mb-8">
        ...
        <div className="space-y-3">
          <div className="bg-red-50 p-4 rounded-lg">
            <h3 className="font-bold text-red-900 mb-2">⚠️ FIL Price Volatility</h3>
          ...
          <div className="bg-yellow-50 p-4 rounded-lg">
            <h3 className="font-bold text-yellow-900 mb-2">⚠️ Datacap Allocation Dependency</h3>
          ...
          <div className="bg-orange-50 p-4 rounded-lg">
            <h3 className="font-bold text-orange-900 mb-2">⚠️ Hardware Obsolescence</h3>
        ...
        <div className="grid grid-cols-2 gap-4 text-sm">
          <div>
            <ul className="space-y-1">
              <li>• FIL price: $5.50 USD stable</li>
              <li>• USD/CAD: 1.38 exchange rate</li>
              <li>• Datacap multiplier: {datacapMultiplier}x maintained</li>
              <li>• 95% uptime/quality score</li>
              <li>• Hardware lifespan: 4-5 years</li>
            </ul>
          </div>
          <div>
            <ul className="space-y-1">
              <li>• Quebec power: ${powerCost}/kWh</li>
              <li>• No regulatory changes</li>
              <li>• Steady state reached month 3</li>
              <li>• No slashing penalties</li>
              <li>• 7% financing rate</li>
            </ul>
          </div>
        </div>
      </div>
...
export default FilecoinBusinessPlan;